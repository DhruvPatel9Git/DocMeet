...
router.put('/doctor/completedAppointment',protect1,doctorController.completedAppointment1)
router.get('/doctor/getDataAppointment/:_id',protect1,doctorController.filterData1)
router.get('/doctor/getPrescriptions/:patientEmail', doctorController.getPrescriptionsByEmail)
