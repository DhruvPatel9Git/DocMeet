...
function AddPrescription() {
  ...
  useEffect(() => {
    if (_id) {
      axios
        .get(
          `https://docmeet1.onrender.com/docmeet/doctor/getDataAppointment/${_id}`,
          {
            headers: {
  ...
  const onHandleSubmit = async () => {
    ...
    try {
      await axios.post(
        `https://docmeet1.onrender.com/docmeet/doctor/addPrescription`,
        formData,
        {
          headers: {
        ...
        <div className="bg-white px-4 md:px-8 py-6 border rounded w-full max-w-4xl mx-auto flex-grow shadow-md">
          ...
          <div className="flex flex-col gap-4 text-gray-600">
            ...
            <TextareaField
              ...
              value={
                prescriptionData.additionalInfo
                  ? prescriptionData.additionalInfo
                  : " "
              }
            />
