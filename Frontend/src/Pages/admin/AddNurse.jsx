...
function AddNurse() {
    ...
    useEffect(() => {
        axios.get('http://localhost:5001/docmeet/user/allDoctors')
            .then(res => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const nurseData = { nurseName, nurseEmail, nursePassword, nurseAge, doctorID: selectedDoctor };

        axios.post('http://localhost:5001/docmeet/admin/addNurse', nurseData)
            .then(res => {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen">
            ...
            <div className="flex-grow flex justify-center items-center p-4">
                ...
                >
                    <h2 className="text-2xl font-semibold text-center text-gray-700">Add Nurse</h2>

                    <div className="space-y-4">
                        <div>
                            <label className="block mb-1 font-medium text-gray-700">Nurse Name</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block mb-1 font-medium text-gray-700">Nurse Email</label>
                            <input
                                type="email"
                        ...
                        <div>
                            <label className="block mb-1 font-medium text-gray-700">Nurse Password</label>
                            <input
                                type="password"
                        ...
                        <div>
                            <label className="block mb-1 font-medium text-gray-700">Nurse Age</label>
                            <input
                                type="number"
                                ...
                                {doctorList.length > 0 ? (
                                    doctorList.map((doc) => (
                                        <label
                                            ...
                                            ${selectedDoctor === doc._id ? 'border-[#5D6BFF] bg-blue-50' : 'border-gray-300 hover:border-blue-400'}`}
                                        >
