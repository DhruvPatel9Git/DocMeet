...
function ForgotPasswordPage() {
  ...
  const handleEmailSubmit = () => {
    setLoading(true);
    axios
      .post("https://docmeet1.onrender.com/docmeet/user/resetpassword", {
        email,
      })
      .then((res) => {
  ...
  const handleOtpSubmit = () => {
    axios
      .post("https://docmeet1.onrender.com/docmeet/user/verifyotp", {
        email,
        otp,
      })
      .then((res) => {
  ...
  const handleResetPassword = () => {
    ...
    axios
      .post("https://docmeet1.onrender.com/docmeet/user/newpassword", {
        email,
        newPassword,
      })
      .then((res) => {
        ...
        {step === 2 && (
          <>
            ...
            <button
              ...
              className="bg-[#5D6BFF] text-white w-full py-2 rounded-lg mt-3"
            >
              Verify OTP
            </button>
          </>
