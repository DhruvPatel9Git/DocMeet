...
export const AuthProvider = ({ children }) => {
  ...
  const getUserData = () => {
    axios
      .get(`https://docmeet1.onrender.com/docmeet/user/dashboardName`, {
        headers: {
  ...
  useEffect(() => {
    ...
    if (doctorToken && !doctorData) {
      axios
        .get(
          "https://docmeet1.onrender.com/docmeet/doctor/doctordashboardName",
          {
            headers: {
              Authorization: `Bearer ${doctorToken}`,
            },
  ...
  const login = async (token) => {
    ...
    try {
      const res = await axios.get(
        "https://docmeet1.onrender.com/docmeet/user/dashboardName",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
